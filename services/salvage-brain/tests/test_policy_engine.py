...
def test_policy_chooses_switch_rail_when_current_rail_is_down() -> None:
    ...
    current_snapshot = _dummy_snapshot("HDFC|UPI|RAZORPAY", RailState.DOWN)
    alt_snapshot = _dummy_snapshot("ICICI|UPI|RAZORPAY", RailState.HEALTHY)
    ...
    assert decision.target_rail_id == "ICICI|UPI|RAZORPAY"
